...
class UserRedux extends Component {
    ...
    onChangeInput = (event, id) => {
        ...
        this.setState({
            ...
            // console.log('ckeck inpit onchange', this.state)
        })
    }
    ...
    handleSaveUser = () => {
        ...
        // }, 1000); //chờ lưu vào Db đã rồi mới render? lại
    ...
    checkValidateInput = () => {
        ...
        for (let i = 0; i < arrCheck.length; i++) {
            if (!this.state[arrCheck[i]]) {
                isValid = false
                alert('điền thiếu ' + arrCheck[i] + ' kìa chú em')
                break
            }
    ...
    handleEditUserFromParent = (user) => {
        // console.log('hoidanit chekc handle edit user from parnet', user)
        let imageBase64 = ''
