...
export const ClinicMenu = [
    ...
    },
    {
        ...
        menus: [
            { name: 'Lịch biểu', link: '' },
            { name: 'Lập lịch biểu cho bác sĩ', link: '/system/ThoiGianBieu' },
            { name: 'ManageSchedule bản cũ, dùng để nghịch & tìm hiểu', link: '/system/editScheduleDoctor' },
            { name: 'Lập lịch biểu cho gói dịch vụ', link: '' },
        ]
    }
]